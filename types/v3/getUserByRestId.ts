...
export interface GetUserByRestIdVariables {
    userId: string
}
...
export class GetUserByRestId implements TwitterRequest {
    client: TwitterAPI
    ...
    get = async (variables: GetUserByRestIdVariables) => {
        ...
        const json: GetUserByRestIdRes = await res.json()
        return json
    }
...
export interface GetUserByRestIdRes {
    data: Data
}
